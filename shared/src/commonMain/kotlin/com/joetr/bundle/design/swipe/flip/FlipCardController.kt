package com.joetr.bundle.design.swipe.flip
...
import com.joetr.bundle.design.swipe.CardController
import com.joetr.bundle.design.swipe.CardControllerImpl
import com.joetr.bundle.design.swipe.screenWidth
...
fun rememberFlipCardController(): FlipCardController {
    ...
    val screenWidth = if (iOS) {
        with(LocalDensity.current) { screenWidth().value }
    } else {
